...
* **Cybernetics**: 観測、判断、制御、フィードバック
* **Buckminster Fuller**: 個別部品ではなくシステム全体を見る
* **Human-Centered Systems Thinking**: 人間の認知、判断、介入を含むシステム観
* **Pragmatism**: 実際に使えること、試せること、改善できること
* **Stewardship**: 保守され、変化に耐える設計
* **Bauhaus**: 芸術と工学の統合

### Information Architecture

* **Legibility**: 複雑なシステムを人間が読める形にする
* **Wurman**: 分類、探索、理解
* **Vignelli**: 秩序、体系、一貫性
* **Tufte**: 情報密度、比較、可視化
* **Alexander**: 再利用可能な設計パターン

### Interaction Design

* **Don Norman**: 認知、Affordance、Feedback、Mapping
* **Jef Raskin**: 操作コスト、認知負荷、作業速度
* **Calm Technology**: 静かなテクノロジー
* **Apple HIG**: 直感性、質感、自然な動き

### Visual Design

* **Swiss Style**: グリッド、可読性、階層
* **Dieter Rams**: 抑制、誠実さ、長命性
* **Linear**: 高速で開発者向けのSaaS体験
